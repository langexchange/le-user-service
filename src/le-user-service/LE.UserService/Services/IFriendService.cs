...
namespace LE.UserService.Services
{
    public interface IFriendService
    {
        ...
        Task<IEnumerable<UserDto>> GetFriendsAsync(Guid id, CancellationToken cancellationToken);
        Task<IEnumerable<UserDto>> GetFriendRequestsAsync(Guid id, CancellationToken cancellationToken);
