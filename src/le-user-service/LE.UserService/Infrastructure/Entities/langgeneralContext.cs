...
{
    public partial class langgeneralContext : DbContext
    {
        public langgeneralContext()
        {
        }

        public langgeneralContext(DbContextOptions<langgeneralContext> options)
            : base(options)
        {
        }
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            {
                optionsBuilder.UseNpgsql(Env.DB_CONNECTION_STRING);
            }
        }
